...
Use ResourceDictionary, DynamicResource/StaticResource deliberately, Styles, ControlTemplates, DataTemplates, VisualStates/Triggers, and layout panels according to content. Preserve binding/state logic. Avoid replacing native behavior with visual-only fake controls.
