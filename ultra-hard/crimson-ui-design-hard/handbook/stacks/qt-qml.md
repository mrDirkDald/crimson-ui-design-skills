...
Prefer Qt Quick/QML for modern declarative UI when architecture permits; centralize palette/metrics in singleton/theme objects, use Layouts before manual positioning, states/transitions deliberately, and Accessible properties. For Widgets, use styles/palettes carefully rather than fragile global stylesheets.
