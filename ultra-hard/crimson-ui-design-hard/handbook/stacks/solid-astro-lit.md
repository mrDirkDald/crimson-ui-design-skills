# Solid / Astro / Lit / Web Components

## Implementation lens

Preserve native semantics and hydration boundaries. Avoid shipping interaction where static HTML is enough. Define token/theming contracts that cross component boundaries safely.
