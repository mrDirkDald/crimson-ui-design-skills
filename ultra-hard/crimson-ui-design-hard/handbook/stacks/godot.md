...
Use Control nodes, Containers, anchors, themes, focus neighbors, input actions, resolution/stretch strategy, and gamepad navigation. HUD and menus need different density/visibility rules.
