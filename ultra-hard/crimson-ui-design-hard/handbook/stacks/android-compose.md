...
Use Material Theme only as a base when it fits. Centralize ColorScheme/Typography/Shapes or custom tokens, use state hoisting, remember/derivedState carefully, WindowInsets, adaptive navigation, semantics, large text, and touch targets.
