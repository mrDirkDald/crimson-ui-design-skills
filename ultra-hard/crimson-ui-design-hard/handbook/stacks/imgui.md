...
Immediate-mode UI excels at tools/debug/editor surfaces. Define shared style constants, spacing, color roles, docking behavior, keyboard focus, scalable fonts, and persistent state. Do not imitate consumer marketing UI with excessive cards/glows in a debug-tool toolkit.
