...
Preserve LookAndFeel/native behavior where useful, use layout managers, actions/key bindings, accessible contexts, and EDT correctness. Modernize hierarchy and spacing without turning every panel into custom-painted widgets.
