...
Use platform-adaptive navigation and safe areas, dynamic type/font scaling, accessible props, pressable states, keyboard avoidance, performant lists, and vector/SVG icon packages. Do not blindly copy web spacing to mobile.
