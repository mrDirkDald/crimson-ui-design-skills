...
Identify whether the toolkit is immediate/declarative. Centralize theme and dimensions, design explicit component states, account for scaling/fonts, and preserve async/data state. Use vector icons through toolkit SVG support where available.
