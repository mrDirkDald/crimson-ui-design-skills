...
Use resource dictionaries/styles, VisualStateManager, Shell/navigation where appropriate, safe-area/platform adaptation, touch target sizing, and native accessibility semantics. Avoid lowest-common-denominator visuals.
