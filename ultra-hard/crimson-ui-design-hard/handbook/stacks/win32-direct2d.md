...
Own DPI scaling, focus, keyboard navigation, hit testing, text rendering, high contrast, window resize behavior, and accessibility/UI Automation deliberately. Build reusable layout/style primitives before pixel-positioning every control.
