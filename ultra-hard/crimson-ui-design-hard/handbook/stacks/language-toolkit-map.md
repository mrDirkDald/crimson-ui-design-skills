...
## HARD language-level guides

For implementation work, pair the toolkit guide with the closest file under `handbook/languages/`. If the language/toolkit is not listed, use `handbook/languages/unknown-language-toolkit.md` and classify the rendering architecture before proposing APIs.
