# Authentication / Account Access Pattern

## Purpose

Use this guide when the target surface primarily behaves like authentication / account access. Preserve domain-specific behavior rather than copying a generic template.

## Core structure

- **sign in**: define the user goal, state, hierarchy, interaction, failure/recovery behavior, responsive treatment, and accessibility semantics.
- **sign up**: define the user goal, state, hierarchy, interaction, failure/recovery behavior, responsive treatment, and accessibility semantics.
- **password reset**: define the user goal, state, hierarchy, interaction, failure/recovery behavior, responsive treatment, and accessibility semantics.
- **SSO**: define the user goal, state, hierarchy, interaction, failure/recovery behavior, responsive treatment, and accessibility semantics.
- **MFA**: define the user goal, state, hierarchy, interaction, failure/recovery behavior, responsive treatment, and accessibility semantics.
- **session state**: define the user goal, state, hierarchy, interaction, failure/recovery behavior, responsive treatment, and accessibility semantics.
