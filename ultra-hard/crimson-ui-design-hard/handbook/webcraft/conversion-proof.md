# Conversion and proof without template collapse

## Purpose

This HARD handbook chapter is a deep operational guide for **conversion and proof without template collapse**. Use it together with `references/web-craft-analysis.md` and the platform/stack guide that actually governs the implementation.

## Detailed rules

1. Tie calls to action to the decision stage; do not repeat one identical CTA after every section.
2. Use proof types that match risk: product evidence, demos, numbers with context, recognizable customers, technical details, guarantees, or case outcomes.
3. Do not fabricate logos, testimonials, ratings, metrics, awards, or success states.
4. Keep conversion hierarchy legible without turning every section into a sales card.
5. Preserve enough specificity that the user knows exactly what happens after the CTA.
