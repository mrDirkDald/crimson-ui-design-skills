# Page architecture and narrative rhythm

## Purpose

This HARD handbook chapter is a deep operational guide for **page architecture and narrative rhythm**. Use it together with `references/web-craft-analysis.md` and the platform/stack guide that actually governs the implementation.

## Detailed rules

1. Design the page as a sequence of narrative beats, not a bag of interchangeable sections.
2. Alternate density, scale, alignment, media, and silence to create rhythm without random novelty.
3. Place proof close to the claim it validates; do not delay all credibility until a generic testimonial strip.
4. Use section boundaries only when the mental model changes; continuous narrative may intentionally cross conventional section boxes.
5. Test whether sections can be shuffled without harming meaning. If they can, the page may lack narrative architecture.
