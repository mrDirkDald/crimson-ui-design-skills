# Anti-AI-default diagnosis

## Purpose

This HARD handbook chapter is a deep operational guide for **anti-ai-default diagnosis**. Use it together with `references/web-craft-analysis.md` and the platform/stack guide that actually governs the implementation.

## Detailed rules

1. Count generic signatures such as centered gradient hero, bento cards, pill badges, feature triples, fake metrics, soft glow, and repeated rounded panels.
2. Do not ban these patterns individually; challenge the unexamined bundle and ask what each structure means for this product.
3. Use logo-removal, section-shuffle, asset-substitution, thumbnail, and five-second-memory tests.
4. Remove decorative containers and rebuild hierarchy through type, spacing, alignment, scale, and real domain objects before restoring semantic surfaces.
5. Prefer one strong product-specific object or workflow over many equally styled support cards.
