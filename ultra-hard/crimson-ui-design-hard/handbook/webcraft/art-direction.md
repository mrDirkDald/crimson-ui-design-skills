...
This HARD handbook chapter is a deep operational guide for **art direction**. Use it together with `references/web-craft-analysis.md` and the platform/stack guide that actually governs the implementation.

## Detailed rules

1. Derive a visual thesis from the product subject, audience, proof, and brand tension before choosing components.
2. Define what should be memorable after five seconds and what should remain deliberately quiet.
3. Select one or two recurring visual devices that can survive across sections without becoming decoration spam.
4. Build media, typography, geometry, and motion around the same thesis instead of independently styling each section.
5. Document anti-references: visual habits that would make this product look like an unrelated SaaS template.
