# Content and microcopy craft

## Purpose

This HARD handbook chapter is a deep operational guide for **content and microcopy craft**. Use it together with `references/web-craft-analysis.md` and the platform/stack guide that actually governs the implementation.

## Detailed rules

1. Write from the user decision or action, not from internal feature taxonomy.
2. Prefer concrete verbs, outcomes, limits, and proof over vague premium/innovative/next-generation claims.
3. Keep navigation labels and controls predictable even when editorial headlines are expressive.
4. Design copy for localization expansion and narrow widths.
5. Never invent factual claims, testimonials, company logos, metrics, guarantees, or compatibility.
