# Portfolio and case-study craft

## Purpose

This HARD handbook chapter is a deep operational guide for **portfolio and case-study craft**. Use it together with `references/web-craft-analysis.md` and the platform/stack guide that actually governs the implementation.

## Detailed rules

1. Lead with the work or outcome rather than a generic agency manifesto unless the brand itself is the subject.
2. Show process only when it proves judgment; avoid decorative process diagrams with no decision value.
3. Use project-specific art direction while preserving enough navigation consistency across the portfolio.
4. Separate authorship, role, collaborators, scope, and outcomes clearly.
5. Balance cinematic media with fast access to project facts and next-project navigation.
