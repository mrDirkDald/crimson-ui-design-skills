# Experimental / immersive web

## Purpose

This HARD handbook chapter is a deep operational guide for **experimental / immersive web**. Use it together with `references/web-craft-analysis.md` and the platform/stack guide that actually governs the implementation.

## Detailed rules

1. Define the experience thesis and fallback before committing to WebGL, 3D, canvas, sound, or scroll choreography.
2. Use spectacle to express the subject; do not add 3D because award sites often use 3D.
3. Keep navigation, escape routes, reduced-motion mode, and meaningful text available outside the spectacle layer.
4. Budget memory, GPU, battery, thermal cost, and low-power fallback.
5. Test interaction with trackpad, mouse, keyboard, touch, reduced motion, and slower devices.
