---
name: crimson-ui-color-theme-adaptation
description: Deep aspect subskill for light / dark theme adaptation within the Crimson UI Design MAX system.
---
...
Preserve product identity and hierarchy across themes without mechanical inversion.
...
Rebuild surface elevation and contrast relationships for each theme rather than inverting colors mathematically.
...
Keep accent family recognizable while adjusting lightness/chroma for each background context.
...
Check borders, dividers, disabled states, selections, code blocks, charts, media overlays, and focus rings in every theme.
...
Avoid neon bloom in dark mode and washed-out pastel controls in light mode.
