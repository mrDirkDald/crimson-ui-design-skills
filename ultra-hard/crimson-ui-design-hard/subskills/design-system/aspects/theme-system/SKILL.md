---
name: crimson-ui-design-system-theme-system
description: Deep aspect subskill for theme system within the Crimson UI Design MAX system.
---
...
Build light/dark/high-contrast or branded themes as semantic remapping instead of duplicated component styling.
...
Keep theme differences primarily at token level.
...
Verify every semantic role exists in every supported theme.
...
Avoid theme-specific orphan colors and component exceptions.
...
Test media, icons, charts, code, selection, focus, disabled, and overlays in each theme.
...
Preserve brand identity while adapting luminance/chroma to the environment.
...
- [ ] token parity
- [ ] no orphan theme values
- [ ] components theme-agnostic
- [ ] focus/selection checked
- [ ] media/chart parity
