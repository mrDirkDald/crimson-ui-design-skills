---
name: crimson-ui-qa-responsive-cross-platform
description: Deep aspect subskill for responsive and cross-platform audit within the Crimson UI Design MAX system.
---

# Responsive and Cross-Platform Audit

## Purpose

Verify layout and behavior across widths, input modes, platforms, themes, DPI, and window sizes.

This is a **deep aspect subskill**. Use it after loading the parent `qa` skill when this aspect materially affects the result.
...
Test representative widths where composition actually changes.
...
Check touch vs keyboard/mouse affordances where applicable.
...
Verify high DPI, zoom, localization expansion, safe areas, and split-screen conditions relevant to the product.
...
Do not infer platform correctness from one browser/OS screenshot.
...
Record environment details for every failure.
...
- [ ] critical widths tested
- [ ] input modes tested
- [ ] DPI/zoom checked
- [ ] localization pressure checked
...
- `../../../../handbook/qa/responsive-audit.md`
- `../../../../handbook/qa/platform-audit.md`
