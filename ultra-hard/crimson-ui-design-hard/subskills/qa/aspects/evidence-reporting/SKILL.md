---
name: crimson-ui-qa-evidence-reporting
description: Deep aspect subskill for evidence and qa reporting within the Crimson UI Design MAX system.
---

# Evidence and QA Reporting

## Purpose

Produce actionable QA reports that distinguish proof, uncertainty, blockers, severity, and next action.
...
Use PASS / FAIL / NOT REVIEWED / BLOCKED / N/A / UNKNOWN consistently.
...
Never call unrun behavior PASS.
...
Attach each failure to state, viewport/platform, evidence, user impact, severity, and likely governing layer.
...
Close the loop by rerunning affected checks after fixes.
