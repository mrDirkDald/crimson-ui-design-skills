---
name: crimson-ui-visual-composition-hierarchy
description: Deep aspect subskill for composition and visual hierarchy within the Crimson UI Design MAX system.
---
...
Control visual mass, grouping, anchors, and action hierarchy across the entire surface.
...
Identify first anchor, primary job, primary action, primary content, current state, secondary controls, and tertiary metadata.
...
Allocate visual mass according to task importance rather than card size or decorative opportunity.
...
Use alignment, whitespace, typography, and grouping before borders/elevation.
...
Prevent support surfaces from becoming accidental co-primary experiences.
...
Use asymmetry only when it creates purposeful tension or focus.
...
- [ ] work area dominates appropriately
- [ ] support surfaces subordinate
- [ ] alignment lines coherent
...
- `../../../../handbook/core/layout-composition.md`
