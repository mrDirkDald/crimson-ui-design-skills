---
name: crimson-ui-visual-imagery-art-direction
description: Deep aspect subskill for imagery and art direction within the Crimson UI Design MAX system.
---
...
Integrate images, screenshots, illustration, video, and backgrounds into the composition intentionally.
...
Define focal point, crop, text-safe zones, local contrast, loading behavior, and responsive crop.
...
Use directional/local overlays rather than blindly darkening the entire image.
...
Do not let decorative media compete with controls or destroy legibility.
...
Use product imagery that carries real identity or information; avoid generic filler stock media.
...
Ensure fallback states still preserve structure and meaning if media fails.
...
- [ ] text-safe contrast verified
- [ ] mobile crop intentional
- [ ] fallback exists
- [ ] media supports product identity
