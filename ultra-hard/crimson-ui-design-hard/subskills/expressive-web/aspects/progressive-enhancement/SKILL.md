---
name: crimson-ui-expressive-web-progressive-enhancement
description: Deep aspect subskill for progressive enhancement and performance within the Crimson UI Design MAX system.
---
...
Keep expressive sites usable when motion, JS, WebGL, audio, or high-end rendering is unavailable.

This is a **deep aspect subskill**. Use it after loading the parent `expressive-web` skill when this aspect materially affects the result.
...
Core content and primary navigation/actions must survive failure of advanced layers.
...
Respect reduced motion and data/power constraints where detectable or user-controlled.
...
Avoid blocking the page behind non-essential intro/loading sequences.
...
Measure expensive effects against their experiential value.
...
Design graceful degradation intentionally rather than treating it as an afterthought.
...
- [ ] reduced motion path
- [ ] no blocking intro dependency
- [ ] heavy effects justified
- [ ] fallback designed
...
- `../../../../handbook/core/performance-design.md`
