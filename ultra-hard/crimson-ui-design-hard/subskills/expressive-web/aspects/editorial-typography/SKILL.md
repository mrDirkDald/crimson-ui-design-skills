---
name: crimson-ui-expressive-web-editorial-typography
description: Deep aspect subskill for editorial typography within the Crimson UI Design MAX system.
---
...
Use expressive typography as structure and identity without sacrificing reading flow.
...
Use scale, contrast, orientation, cropping, rhythm, and negative space intentionally.
...
Keep long-form reading width and line-height stable even when display type is experimental.
...
Avoid every section having a unique typographic trick.
...
Protect responsive recomposition so display type does not simply shrink into unreadability.
...
Maintain accessible semantics even when visual order is unconventional.
...
- [ ] display/body roles distinct
- [ ] reading comfort preserved
