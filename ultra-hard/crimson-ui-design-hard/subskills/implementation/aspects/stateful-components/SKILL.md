---
name: crimson-ui-implementation-stateful-components
description: Deep aspect subskill for stateful component implementation within the Crimson UI Design MAX system.
---
...
Implement loading, error, selection, focus, validation, disabled, optimistic, and transient states explicitly.
...
Keep visual state derived from real application state rather than ad-hoc DOM/class toggles.
...
Make disabled reasons understandable when the action is important.
...
Preserve focus and selection through re-render/reordering.
...
Avoid fake controls that look interactive but have no behavior.
