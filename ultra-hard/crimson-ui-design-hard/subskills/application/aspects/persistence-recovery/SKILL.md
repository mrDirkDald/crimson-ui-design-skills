---
name: crimson-ui-application-persistence-recovery
description: Deep aspect subskill for persistence and recovery within the Crimson UI Design MAX system.
---
...
Protect application state, unsaved work, undo, failure recovery, and destructive actions.
...
Prefer undo for safely reversible actions over excessive confirmation dialogs.
...
Use explicit dirty/unsaved state when loss is possible.
...
Differentiate autosave, saved, saving, failed-to-save, and conflict states.
...
Preserve user input after validation/network/storage errors whenever possible.
...
Design recovery for crash/restart/background interruption where product expectations justify it.
