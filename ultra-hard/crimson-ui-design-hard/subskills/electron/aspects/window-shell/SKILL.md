---
name: crimson-ui-electron-window-shell
description: Deep aspect subskill for window and shell ux within the Crimson UI Design MAX system.
---
...
Design Electron window behavior, chrome, multi-window flows, and platform integration coherently.
...
Use native window conventions unless custom chrome has a clear product reason.
...
Preserve resize, maximize, fullscreen, drag regions, minimum size, and DPI behavior.
...
Avoid frameless-window affordance loss such as invisible drag regions or inaccessible window controls.
...
Define ownership between primary windows, dialogs, utility windows, and background surfaces.
...
Persist window geometry carefully and recover when displays change.
...
- [ ] window controls usable
- [ ] resize robust
- [ ] drag regions safe
- [ ] multi-window ownership clear
- [ ] display changes recover
...
- `../../../../handbook/platforms/windows.md`
- `../../../../handbook/platforms/macos.md`
