---
name: crimson-ui-electron-electron-security
description: Deep aspect subskill for electron security and ux boundaries within the Crimson UI Design MAX system.
---

# Electron Security and UX Boundaries

## Purpose

Prevent design/implementation choices from weakening Electron's security model.
...
Keep context isolation and narrow bridges unless a reviewed architecture requires otherwise.
...
Treat remote/untrusted content as hostile and do not expose privileged APIs to it.
...
Validate file/process/shell actions on the privileged side.
...
Avoid UX patterns that encourage users to bypass OS trust or permission signals.
...
Make permission denials and unavailable capabilities recoverable and understandable.
...
- [ ] context boundary intact
- [ ] untrusted content isolated
- [ ] privileged inputs validated
- [ ] OS trust respected
- [ ] denials recoverable
