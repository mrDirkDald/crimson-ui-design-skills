---
name: crimson-ui-electron-renderer-ux
description: Deep aspect subskill for electron renderer ux within the Crimson UI Design MAX system.
---
...
Apply application design principles inside the renderer without treating Electron as merely a website wrapper.
...
Use desktop density, menus, shortcuts, focus, selection, and window behavior appropriate to the target OS.
...
Do not load web-marketing patterns into operational desktop surfaces.
...
Coordinate renderer loading states with native/background work.
...
Keep text selection, drag/drop, clipboard, file paths, and context actions platform-appropriate.
...
- [ ] desktop conventions applied
- [ ] web-marketing patterns avoided
- [ ] native/background states coordinated
- [ ] clipboard/drag-drop appropriate
- [ ] DPI tested
