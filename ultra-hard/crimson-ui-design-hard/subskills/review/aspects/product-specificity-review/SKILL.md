---
name: crimson-ui-review-product-specificity-review
description: Deep aspect subskill for product-specificity review within the Crimson UI Design MAX system.
---
...
Detect generic AI-template design and reconnect structure to the product's real domain.

This is a **deep aspect subskill**. Use it after loading the parent `review` skill when this aspect materially affects the result.
...
Temporarily remove logo, brand name, hero image, and marketing copy when judging structural specificity.
...
Ask whether the same layout could be relabeled for unrelated products with almost no change.
...
Strengthen specificity through workflow, content model, controls, state, data, terminology, and interaction before adding decoration.
...
Do not use random thematic ornaments as a substitute for product-grounded structure.
...
Keep familiar conventions where they help users; specificity is not novelty for its own sake.
...
- [ ] domain workflow visible
- [ ] real product data/state represented
- [ ] generic template signals identified
- [ ] novelty justified
- [ ] branding not carrying all specificity
...
- `../../../../handbook/core/product-specificity.md`
