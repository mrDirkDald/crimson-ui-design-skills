---
name: crimson-ui-review-refine-vs-redesign
description: Deep aspect subskill for refine vs redesign within the Crimson UI Design MAX system.
---
...
Choose the smallest design phase that can solve the real problem without patch accumulation.
...
Use REFINE when the governing structure is coherent and failures are local.
...
Use REDESIGN when multiple failures share a systemic cause across hierarchy, color, typography, spacing, surfaces, navigation, or product specificity.
...
Do not escalate because redesign is more interesting or visually dramatic.
...
Do not stay in REFINE when every local fix introduces exceptions or contradicts neighboring components.
...
Record why local patches are insufficient before broad replacement.
...
- [ ] local-fix viability assessed
- [ ] systemic conflicts grouped
- [ ] preservation risk reviewed
- [ ] phase justified
...
- `../../../../handbook/core/anti-patterns.md`
