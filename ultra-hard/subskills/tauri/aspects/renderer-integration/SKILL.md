---
name: crimson-ui-tauri-renderer-integration
description: Deep aspect subskill for renderer integration within the Crimson UI Design MAX system.
---
...
Apply web/TS UI implementation cleanly inside a Tauri shell without importing unnecessary web-only patterns.
...
Use the renderer stack's strengths while keeping desktop workflow conventions primary.
...
Do not load marketing-web architecture just because the renderer uses HTML/CSS.
...
Coordinate frontend state with native events and commands explicitly.
...
Keep Lucide/SVG iconography coherent with native/window controls.
...
Verify resizing, high DPI, focus, shortcuts, drag/drop, and native dialogs.
...
- [ ] desktop UX primary
- [ ] native/frontend state coordinated
- [ ] icons coherent
- [ ] resize/DPI verified
- [ ] shortcuts/dialogs tested
