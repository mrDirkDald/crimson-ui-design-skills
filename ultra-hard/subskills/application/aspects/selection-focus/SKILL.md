---
name: crimson-ui-application-selection-focus
description: Deep aspect subskill for selection and focus within the Crimson UI Design MAX system.
---
...
Keep current selection, keyboard focus, multi-selection, and inspector ownership unambiguous.

This is a **deep aspect subskill**. Use it after loading the parent `application` skill when this aspect materially affects the result.
...
Do not style selected and focused states identically when both can exist simultaneously.
...
Preserve selection across non-destructive operations where users expect continuity.
...
Define multi-select anchor/range behavior and bulk-action visibility.
...
Ensure inspectors/editors clearly indicate what object they control.
...
Restore sensible focus after dialogs, deletions, navigation, and asynchronous updates.
...
- [ ] focus visible
- [ ] selection distinct
- [ ] multi-select behavior defined
- [ ] inspector ownership clear
- [ ] focus restoration tested
...
- `../../../../handbook/core/input-and-command.md`
- `../../../../handbook/core/component-anatomy.md`
