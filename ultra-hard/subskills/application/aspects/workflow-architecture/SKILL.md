---
name: crimson-ui-application-workflow-architecture
description: Deep aspect subskill for workflow architecture within the Crimson UI Design MAX system.
---
...
Shape application UI around the sequence of user decisions and state transitions.
...
Map the primary workflow before styling controls.
...
Keep high-frequency actions close to the working context and low-frequency settings out of the main path.
...
Show current state, next valid action, and recovery path.
...
Avoid dashboards that summarize when the user actually needs a workspace.
...
Preserve task continuity across navigation, restart, and recoverable errors where the product supports it.
...
- [ ] primary workflow mapped
- [ ] high-frequency actions nearby
- [ ] state visible
- [ ] recovery visible
- [ ] summary vs workspace choice justified
...
- `../../../../handbook/core/information-architecture.md`
