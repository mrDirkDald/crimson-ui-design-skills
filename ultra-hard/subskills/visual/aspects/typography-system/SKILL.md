---
name: crimson-ui-visual-typography-system
description: Deep aspect subskill for typography system within the Crimson UI Design MAX system.
---
...
Build readable hierarchy, rhythm, density, and identity through type rather than arbitrary font-size jumps.
...
Define explicit roles for display, title, section, body, controls, metadata, technical/code, numeric/tabular, and captions.
...
Use weight, size, line-height, width, case, and spacing as a coordinated system.
...
Avoid giant hero type where it overwhelms repeated-use tasks.
...
Avoid tiny metadata fog and low-contrast auxiliary text that becomes effectively unreadable.
...
Use display fonts selectively; body and control typography must remain stable and legible.
...
- [ ] body contrast sufficient
- [ ] metadata readable
- [ ] numeric alignment handled
