---
name: crimson-ui-visual-iconography-svg
description: Deep aspect subskill for iconography and svg within the Crimson UI Design MAX system.
---
...
Maintain a coherent vector icon language with Lucide as the default fallback system.
...
Preserve an existing coherent icon system; otherwise use Lucide before inventing a new generic pack.
...
Use custom SVG for brand/domain-specific concepts that generic libraries cannot express accurately.
...
Normalize viewBox, stroke/fill model, optical size, baseline, and currentColor behavior.
...
Do not use emoji or arbitrary Unicode pictograms as UI icons.
...
Give icon-only controls accessible names and keep hit targets larger than the visible glyph when needed.
...
- `../../../../handbook/core/iconography-lucide.md`
- `../../../../handbook/qa/icon-audit.md`
