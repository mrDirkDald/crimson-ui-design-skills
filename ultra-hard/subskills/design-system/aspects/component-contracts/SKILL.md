---
name: crimson-ui-design-system-component-contracts
description: Deep aspect subskill for component contracts and variants within the Crimson UI Design MAX system.
---
...
Define component anatomy, variants, slots, states, and composition boundaries consistently.
...
Model variants around meaningful behavior/semantics rather than every visual permutation.
...
Define required states: default, hover, focus, pressed, selected, disabled, loading, validation as applicable.
...
Keep component responsibilities narrow enough to compose without prop explosions.
...
Separate content slots from style overrides.
...
Do not encode application-specific business logic into globally shared visual primitives without need.
