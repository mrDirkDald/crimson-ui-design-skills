...
Load `../../references/web-craft-analysis.md` when the user explicitly wants a beautiful, premium, distinctive, studio-quality, brand, campaign, launch, portfolio, or award-level website.
...
For beautiful or strongly art-directed sites also read `references/web-craft-analysis.md`, `references/skills-sh-patterns.md`, and relevant `handbook/webcraft/` chapters.
