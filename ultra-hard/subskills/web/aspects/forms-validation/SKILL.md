---
name: crimson-ui-web-forms-validation
description: Deep aspect subskill for forms and validation within the Crimson UI Design MAX system.
---
...
Design web forms that preserve user input, explain errors, and prevent duplicate or ambiguous submission.
...
Use persistent labels when field identity must survive typing.
...
Validate at useful times and place errors near the responsible input.
...
Preserve valid input after server/client failure.
...
Handle loading, disabled, dependent, success, failure, retry, and unsaved states explicitly.
...
Use correct input types, autocomplete, keyboard behavior, and accessible descriptions.
...
- [ ] labels persistent
- [ ] errors local and clear
- [ ] input preserved
- [ ] duplicate submit prevented
- [ ] keyboard/autofill checked
...
- `../../../../handbook/core/forms-and-validation.md`
- `../../../../handbook/patterns/authentication.md`
