---
name: crimson-ui-electron-native-dialogs-menus
description: Deep aspect subskill for native dialogs, menus, and os integration within the Crimson UI Design MAX system.
---

# Native Dialogs, Menus, and OS Integration

## Purpose

Choose between native Electron/OS surfaces and custom UI intentionally.

This is a **deep aspect subskill**. Use it after loading the parent `electron` skill when this aspect materially affects the result.
...
Use native file dialogs for filesystem selection unless product requirements demand otherwise.
...
Use platform menus/accelerators where conventions improve discoverability and keyboard access.
...
Do not fake native system permission prompts inside renderer UI.
...
Keep destructive confirmations proportional and prefer undo where safe.
...
Ensure custom dialogs preserve modal focus and keyboard behavior.
...
- [ ] native/custom choice justified
- [ ] keyboard access works
- [ ] permissions not spoofed
- [ ] modal focus correct
- [ ] destructive flow safe
...
- `../../../../handbook/core/windows-dialogs-overlays.md`
