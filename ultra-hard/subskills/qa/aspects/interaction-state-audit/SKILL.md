---
name: crimson-ui-qa-interaction-state-audit
description: Deep aspect subskill for interaction state audit within the Crimson UI Design MAX system.
---
...
Verify hover, focus, pressed, selected, disabled, loading, success, error, and recovery states.
...
Test state transitions in the runtime, not only CSS declarations.
...
Check rapid repeated interaction and async race conditions where relevant.
...
Ensure focus-visible remains visible and is not confused with selection.
...
Verify disabled controls communicate state without looking active.
...
Test error recovery and retry, not merely initial failure display.
...
- [ ] all relevant states exercised
- [ ] focus visible
- [ ] rapid input stable
- [ ] disabled semantics clear
- [ ] recovery tested
