---
name: crimson-ui-qa-accessibility-audit
description: Deep aspect subskill for accessibility audit within the Crimson UI Design MAX system.
---
...
Verify semantic, keyboard, focus, contrast, target-size, motion, screen-reader, and adaptive requirements.
...
Audit real component semantics and accessible names.
...
Test keyboard order, focus trap/restoration, and visible focus.
...
Check contrast per actual foreground/background pair.
...
Ensure color is not the only critical cue.
...
Respect reduced motion, large text, zoom, and platform accessibility APIs where applicable.
...
- `../../../../handbook/qa/accessibility-audit.md`
