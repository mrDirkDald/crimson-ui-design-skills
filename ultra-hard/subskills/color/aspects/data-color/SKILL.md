---
name: crimson-ui-color-data-color
description: Deep aspect subskill for data visualization color within the Crimson UI Design MAX system.
---
...
Use categorical, sequential, diverging, and highlight palettes according to data semantics.
...
Use categorical hues only for peer categories; do not imply order accidentally.
...
Use sequential lightness/chroma for ordered magnitude.
...
Highlight selected series while receding others instead of saturating every series equally.
...
For many categories, combine color with direct labels, markers, line styles, grouping, or small multiples.
...
- [ ] midpoint meaningful
- [ ] legend/direct labels clear
- [ ] color-blind robustness checked
- [ ] selected state dominant
...
- `../../../../handbook/core/data-visualization.md`
- `../../../../handbook/qa/data-viz-audit.md`
