---
name: crimson-ui-review-evidence-audit
description: Deep aspect subskill for evidence audit within the Crimson UI Design MAX system.
---
...
Prove what actually governs the target UI before making design claims.
...
Prefer rendered runtime behavior over assumptions from filenames, comments, or unused components.
...
Trace style ownership through imports, variants, resolved tokens, inheritance, and actual DOM/native tree where available.
...
Separate observed facts from inference and label unavailable runtime evidence as BLOCKED rather than PASS.
...
Capture equivalent before/after states so visual comparison is meaningful.
...
Treat stale screenshots and README guidance as secondary evidence unless they match the current runtime.
...
- [ ] governing component proven
- [ ] active token/theme proven
- [ ] runtime state identified
- [ ] viewport/device noted
- [ ] uncertainty labeled
