---
name: crimson-ui-implementation-design-to-code-verification
description: Deep aspect subskill for design-to-code verification within the Crimson UI Design MAX system.
---
...
Compare implementation against the intended design system and actual runtime constraints.
...
Verify rendered output instead of assuming code structure guarantees appearance.
...
Compare equivalent content, state, viewport, and theme.
...
Inspect typography metrics, overflow, alignment, clipping, focus, and interaction states.
...
Run relevant build/type/lint/tests without treating them as visual proof.
...
Fix governing causes rather than pixel-patching isolated screenshots.
