---
name: crimson-ui-implementation-react-typescript-tailwind
description: Deep aspect subskill for react / typescript / tailwind within the Crimson UI Design MAX system.
---
...
Implement design systems and interaction states cleanly in component-driven TS/Tailwind applications.
...
Keep behavior/state ownership distinct from presentation wrappers.
...
Use variant helpers or component APIs rather than duplicated class strings when repetition becomes structural.
...
Use semantic CSS variables/tokens instead of arbitrary utility colors for brand/state roles.
...
Preserve SSR/hydration constraints in frameworks that render on the server.
...
Avoid component abstractions that make simple visual tuning harder than direct composition.
...
- `../../../../handbook/stacks/react-next.md`
- `../../../../handbook/stacks/tailwind.md`
