---
name: crimson-ui-expressive-web-media-art-direction
description: Deep aspect subskill for media art direction within the Crimson UI Design MAX system.
---
...
Use image, video, texture, collage, and masks as active compositional material.
...
Define focal points and crop logic per breakpoint.
...
Use media transitions to reinforce the experience thesis, not as random reveal effects.
...
Preserve text legibility and avoid constant background competition.
...
Preload or defer heavy media based on actual priority.
...
Provide meaningful poster/fallback states for video and interactive media.
