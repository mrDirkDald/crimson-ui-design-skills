...
Use this checklist on the real product state. Static code alone is insufficient for appearance and interaction claims.

- [ ] hierarchy: inspect rendered behavior and record PASS / FAIL / NOT REVIEWED / BLOCKED / N/A / UNKNOWN.
- [ ] alignment: inspect rendered behavior and record PASS / FAIL / NOT REVIEWED / BLOCKED / N/A / UNKNOWN.
- [ ] spacing: inspect rendered behavior and record PASS / FAIL / NOT REVIEWED / BLOCKED / N/A / UNKNOWN.
- [ ] type roles: inspect rendered behavior and record PASS / FAIL / NOT REVIEWED / BLOCKED / N/A / UNKNOWN.
- [ ] surface language: inspect rendered behavior and record PASS / FAIL / NOT REVIEWED / BLOCKED / N/A / UNKNOWN.
- [ ] color harmony: inspect rendered behavior and record PASS / FAIL / NOT REVIEWED / BLOCKED / N/A / UNKNOWN.
- [ ] icon consistency: inspect rendered behavior and record PASS / FAIL / NOT REVIEWED / BLOCKED / N/A / UNKNOWN.
- [ ] product specificity: inspect rendered behavior and record PASS / FAIL / NOT REVIEWED / BLOCKED / N/A / UNKNOWN.
- [ ] background integration: inspect rendered behavior and record PASS / FAIL / NOT REVIEWED / BLOCKED / N/A / UNKNOWN.

## Reporting

For each material failure record evidence, user impact, root cause, severity, proposed fix, and whether the fix belongs locally or in a shared governing layer.

## Beautiful-web craft audit

For a beautiful / premium / brand-led website, additionally verify:

- [ ] **Logo removal test** — identity still exists without logo/name/accent.
- [ ] **Section shuffle test** — section order expresses a deliberate narrative rather than interchangeable blocks.
- [ ] **Asset substitution test** — generic imagery cannot replace the chosen media without weakening the concept.
- [ ] **Five-second memory test** — the page has a specific memorable device or composition.
- [ ] **Motion-off test** — hierarchy/composition remain strong when animation is disabled.
- [ ] **Whole-page silhouette** — the document has macro rhythm and changing visual density.
- [ ] **AI-default signature count** — generic startup patterns are justified individually rather than appearing as a bundle.
- [ ] **Real-proof test** — testimonials, logos, metrics, claims, and demos are truthful/available rather than invented for visual completeness.
- [ ] **Typography craft** — display/body/metadata roles, line breaks and measure are art-directed rather than default framework typography.
- [ ] **Media coherence** — photography/video/illustration share an intentional art direction.

A visually polished component library does not prove whole-page craft.
