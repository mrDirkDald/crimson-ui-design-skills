# C++ UI Implementation Guide — HARD

## Purpose

Use this guide when UI code is materially implemented in **C++**. Typical ecosystems include **Qt, Win32/Direct2D, wxWidgets, JUCE, SDL, ImGui, Unreal, custom GPU UI**. The language alone does not determine the UI architecture; inspect the actual toolkit and version before applying APIs.

## Primary engineering concern

Pay special attention to **object lifetime, threading, rendering ownership, ABI/toolkit boundaries**.
