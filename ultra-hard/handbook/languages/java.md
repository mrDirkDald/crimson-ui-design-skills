# Java UI Implementation Guide — HARD

## Purpose

Use this guide when UI code is materially implemented in **Java**. Typical ecosystems include **JavaFX, Swing, Android legacy/interoperability**. The language alone does not determine the UI architecture; inspect the actual toolkit and version before applying APIs.

## Primary engineering concern

Pay special attention to **EDT/Application Thread ownership, layout managers, observable state, packaging**.
