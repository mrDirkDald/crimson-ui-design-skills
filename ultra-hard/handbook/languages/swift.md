# Swift UI Implementation Guide — HARD

## Purpose

Use this guide when UI code is materially implemented in **Swift**. Typical ecosystems include **SwiftUI, UIKit, AppKit**. The language alone does not determine the UI architecture; inspect the actual toolkit and version before applying APIs.

## Primary engineering concern

Pay special attention to **main-actor UI work, state ownership, navigation/lifecycle, accessibility**.
