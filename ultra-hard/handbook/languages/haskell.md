# Haskell UI Implementation Guide — HARD

## Purpose

Use this guide when UI code is materially implemented in **Haskell**. Typical ecosystems include **terminal, GTK/Qt bindings, web frontends and custom FRP UIs**. The language alone does not determine the UI architecture; inspect the actual toolkit and version before applying APIs.

## Primary engineering concern

Pay special attention to **FRP/event model clarity, FFI, lazy evaluation/performance boundaries**.
