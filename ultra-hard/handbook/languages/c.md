...
Use this guide when UI code is materially implemented in **C**. Typical ecosystems include **Win32, GTK, SDL, LVGL, raylib, custom renderers, terminal UIs**. The language alone does not determine the UI architecture; inspect the actual toolkit and version before applying APIs.

## Primary engineering concern

Pay special attention to **manual ownership and callback/state discipline**.
