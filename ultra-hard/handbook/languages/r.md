# R UI Implementation Guide — HARD

## Purpose

Use this guide when UI code is materially implemented in **R**. Typical ecosystems include **Shiny and data/scientific interfaces**. The language alone does not determine the UI architecture; inspect the actual toolkit and version before applying APIs.

## Primary engineering concern

Pay special attention to **reactive dependency clarity, long computation, accessible data visualization, server state**.
