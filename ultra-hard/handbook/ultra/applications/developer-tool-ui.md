    # Developer Tool Ui — ULTRA-HARD playbook

    ## Purpose

    Design developer tools around source/context, command execution, logs, diagnostics, state, and safe destructive actions.
