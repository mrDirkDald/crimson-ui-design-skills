...
Fyne/Gio use native/canvas principles; Wails uses web renderer + native shell. Centralize theme, scaling, layout, state, and platform integration according to toolkit.
