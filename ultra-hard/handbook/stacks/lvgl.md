...
Design for limited resolution/memory/input. Centralize styles/themes, use flex/grid layouts where supported, keep animations cheap, ensure touch/physical-control targets, and test sunlight/contrast constraints where relevant.
