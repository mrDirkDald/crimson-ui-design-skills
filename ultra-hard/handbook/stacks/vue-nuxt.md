...
Use component props/slots intentionally, preserve reactive ownership, avoid styling leakage, centralize tokens, and keep route/server data states explicit. Prefer Lucide Vue packages or SVG-compatible wrappers when appropriate.
