...
Use UDim2, UIListLayout/UIGridLayout, constraints, UIScale carefully, safe insets, input modality switching, selection/focus for gamepad, and clear server/client state. Avoid fixed pixel layouts that fail across devices.
