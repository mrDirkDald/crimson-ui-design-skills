# Rails / Laravel / Phoenix LiveView

## Implementation lens

UI is still web UI. Preserve semantic HTML, progressive enhancement, validation, loading/pending state, latency, focus after server updates, and CSS/token architecture.
