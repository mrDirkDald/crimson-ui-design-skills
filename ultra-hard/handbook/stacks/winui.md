...
Use ThemeResource, resource dictionaries, VisualStateManager, NavigationView/CommandBar patterns when appropriate, proper window/backdrop behavior, DPI/theme/high-contrast support, and accessible AutomationProperties.
