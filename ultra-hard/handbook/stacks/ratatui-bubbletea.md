...
Treat focus and keyboard bindings as primary interaction. Use borders/color sparingly to establish hierarchy. Support resize, scroll, help discoverability, and limited terminal color capabilities.
