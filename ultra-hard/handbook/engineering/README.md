# Engineering Support Handbooks

These chapters support UI work when repository engineering becomes material. They are not permission to expand every design task into a full codebase refactor.

Use them for codebase search/navigation, refactoring discipline, performance profiling, QA/bug hunting, release readiness, orchestration, UX copy, premium app/web design, and whole-product improvement.

The task contract and user scope still outrank auxiliary engineering opportunities.
