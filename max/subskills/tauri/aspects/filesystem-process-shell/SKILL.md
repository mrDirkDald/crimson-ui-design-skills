---
name: crimson-ui-tauri-filesystem-process-shell
description: Deep aspect subskill for filesystem, process, and shell ux within the Crimson UI Design MAX system.
---

# Filesystem, Process, and Shell UX

## Purpose

Design safe native file/process interactions without exposing dangerous generic controls.
...
Use constrained file pickers and scoped paths where possible.
...
Separate read, write, execute, and reveal/open-folder actions semantically.
...
Validate paths and arguments natively.
...
Show destructive/irreversible filesystem effects clearly and provide recovery where possible.
...
Do not expose arbitrary shell execution through a generic UI bridge.
