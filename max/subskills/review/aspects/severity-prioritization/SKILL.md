---
name: crimson-ui-review-severity-prioritization
description: Deep aspect subskill for severity and prioritization within the Crimson UI Design MAX system.
---
...
Rank issues by user impact rather than by visual annoyance.
...
BLOCKER means task completion, safety, data integrity, or access is broken.
...
HIGH means major workflow ambiguity, inaccessible core action, or severe hierarchy/state failure.
...
MEDIUM means recurring friction, inconsistency, or scanability loss without blocking the task.
...
LOW means polish drift with limited functional impact.
...
Fix root causes before decorative symptoms and do not let easy low-severity fixes displace hard high-severity ones.
...
- `../../../../handbook/qa/MASTER-CHECKLIST.md`
