---
name: crimson-ui-application-commands-shortcuts
description: Deep aspect subskill for commands and shortcuts within the Crimson UI Design MAX system.
---
...
Design discoverable command surfaces for keyboard, mouse, touch, pen, and context actions.
...
Provide visible command entry points even when shortcuts exist.
...
Use consistent shortcut scope and conflict resolution.
...
Separate destructive, reversible, and navigation commands.
...
Support context menus where platform conventions make them efficient, but do not hide essential commands only there.
...
Expose command availability/disabled reason when state constrains an action.
...
- [ ] scope defined
- [ ] destructive commands separated
- [ ] context menu not sole path
- [ ] disabled reason understandable
