---
name: crimson-ui-application-desktop-mobile-adaptation
description: Deep aspect subskill for desktop / mobile adaptation within the Crimson UI Design MAX system.
---
...
Translate the same product model across pointer/keyboard and touch-constrained environments.
...
Do not merely shrink desktop sidebars, tables, inspectors, and menus onto mobile.
...
Reprioritize around touch targets, one-handed reach, modal depth, and limited simultaneous context.
...
Use desktop shortcuts/context menus without making them the only path.
...
Respect window resizing, high DPI, split screen, rotation, safe areas, and large text where relevant.
...
Preserve semantic continuity between platforms even when layout changes significantly.
...
- [ ] input model adapted
- [ ] navigation adapted
- [ ] dense controls transformed
- [ ] window/rotation tested
