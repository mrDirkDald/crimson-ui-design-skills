---
name: crimson-ui-visual-identity-specificity
description: Deep aspect subskill for identity and product specificity within the Crimson UI Design MAX system.
---

# Identity and Product Specificity

## Purpose

Create a recognizable product language without relying on superficial branding.
...
Ground identity in product behavior, domain vocabulary, interaction, information structure, and visual rhythm.
...
Use one or two memorable recurring motifs rather than many unrelated signature tricks.
...
Avoid generic premium/SaaS/AI visual defaults unless the brief explicitly supports them.
...
Preserve useful platform conventions so identity does not damage usability.
...
Test whether the product remains recognizable when logo and hero art are hidden.
...
- [ ] visual thesis stated
- [ ] motifs consistent
- [ ] domain grounding present
- [ ] generic-template risk assessed
- [ ] platform fit preserved
