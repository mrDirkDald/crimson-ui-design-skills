---
name: crimson-ui-web-navigation-routing
description: Deep aspect subskill for navigation and routing within the Crimson UI Design MAX system.
---
...
Make location, history, back behavior, deep links, and route transitions predictable.
...
Differentiate global navigation, local section navigation, tabs, filters, and in-context actions.
...
Preserve browser back/forward semantics and meaningful URLs where the product supports routing.
...
Do not use tabs for unrelated routes or links for stateful actions without clear reason.
...
Keep active/current state visually and semantically obvious.
...
Ensure keyboard, focus restoration, and scroll restoration behave predictably after navigation.
...
- [ ] active state clear
- [ ] deep links valid
- [ ] focus/scroll restoration checked
...
- `../../../../handbook/core/navigation-deep.md`
- `../../../../handbook/platforms/web-browser.md`
