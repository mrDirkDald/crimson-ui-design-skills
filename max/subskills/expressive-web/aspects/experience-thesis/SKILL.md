---
name: crimson-ui-expressive-web-experience-thesis
description: Deep aspect subskill for experience thesis within the Crimson UI Design MAX system.
---
...
Reduce an expressive site to one memorable governing idea instead of an effect stack.
...
Define one sentence that connects subject, interaction, and visual behavior.
...
Choose one dominant experiential move and let supporting motion remain subordinate.
...
Keep routine navigation and core actions understandable even when presentation is unconventional.
...
Do not copy award-site patterns without translating them into the product's subject matter.
...
Remove effects that do not reinforce the thesis.
...
- [ ] thesis one sentence
- [ ] dominant move identified
- [ ] quiet areas defined
- [ ] product grounding clear
- [ ] unrelated effects removed
