---
name: crimson-ui-expressive-web-scroll-motion
description: Deep aspect subskill for scroll and motion choreography within the Crimson UI Design MAX system.
---

# Scroll and Motion Choreography

## Purpose

Use scroll as spatial/narrative structure without hijacking basic navigation.
...
Tie scroll-driven motion to information progression or spatial reveal.
...
Avoid long pinned sections that delay access to content without adding meaning.
...
Keep scroll velocity, touch behavior, reduced motion, and browser history usable.
...
Use staged choreography with clear hierarchy rather than animating every element independently.
...
Ensure skipped/fast scroll states still resolve correctly.
