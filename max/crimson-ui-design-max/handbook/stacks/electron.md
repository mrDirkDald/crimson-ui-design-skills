...
Preserve context isolation/preload boundaries, IPC contracts, native menus/dialogs, window state, updater/deep link behavior, and browser-renderer accessibility. Do not blur security boundaries for visual convenience.
