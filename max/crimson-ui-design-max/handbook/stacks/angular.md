...
Use reusable components/directives, Angular Material only when it fits rather than as automatic identity, preserve form semantics, signals/observable states, and route/accessibility behavior.
