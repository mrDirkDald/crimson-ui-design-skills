---
name: crimson-ui-qa-visual-regression
description: Deep aspect subskill for visual regression within the Crimson UI Design MAX system.
---
...
Use screenshots/diffs responsibly to detect unintended change without treating every pixel difference as a defect.
...
Compare equivalent state, content, viewport, theme, platform, and font availability.
...
Separate expected intentional changes from regressions.
...
Use tolerance/masking only for known nondeterministic regions.
...
Investigate large diff clusters by root cause rather than accepting broad baselines blindly.
...
Keep golden images tied to meaningful product states.
...
- [ ] nondeterminism controlled
- [ ] diff root cause investigated
- [ ] goldens meaningful
