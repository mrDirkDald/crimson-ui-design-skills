---
name: crimson-ui-web-web-performance-design
description: Deep aspect subskill for web performance as design within the Crimson UI Design MAX system.
---
...
Keep motion, media, fonts, hydration, and layout complexity from degrading the user experience.
...
Treat loading cost, layout shift, interaction delay, and animation jank as design defects when noticeable.
...
Use progressive enhancement for WebGL, heavy motion, video, and large media.
...
Reserve space for async media to reduce layout shift.
...
Do not ship five font families or giant icon bundles for minor visual gain.
...
Ensure reduced-motion and low-capability fallbacks preserve content and primary actions.
...
- [ ] heavy assets justified
- [ ] fallback exists
- [ ] layout shift controlled
- [ ] font/icon loading sane
