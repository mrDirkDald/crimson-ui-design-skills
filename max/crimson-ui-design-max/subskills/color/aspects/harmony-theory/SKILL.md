---
name: crimson-ui-color-harmony-theory
description: Deep aspect subskill for color harmony theory within the Crimson UI Design MAX system.
---
...
Choose hue relationships intentionally instead of assembling attractive swatches independently.
...
Choose analogous, complementary, split-complementary, restrained triadic, monochromatic, or neutral-dominant relationships based on product tone.
...
Control dominance; a harmonious palette still fails if every hue competes at equal saturation.
...
Use lightness structure as seriously as hue relationship.
...
Balance warm/cool temperature according to role rather than distributing it randomly.
...
Judge harmony at whole-screen level, not swatch-card level.
...
- [ ] relationship named
- [ ] dominant hue clear
- [ ] saturation hierarchy clear
- [ ] lightness hierarchy survives grayscale
- [ ] temperature balance intentional
