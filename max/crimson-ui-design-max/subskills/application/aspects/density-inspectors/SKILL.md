---
name: crimson-ui-application-density-inspectors
description: Deep aspect subskill for density, panels, and inspectors within the Crimson UI Design MAX system.
---

# Density, Panels, and Inspectors

## Purpose

Manage dense professional interfaces without burying the primary task in chrome.
...
Use density proportional to task frequency and expertise.
...
Group controls by the object/state they affect rather than arbitrary visual categories.
...
Keep inspectors contextual and avoid persistent empty panels without value.
...
Use progressive disclosure for rare advanced settings.
...
Preserve scanability with alignment, typographic roles, and predictable spacing rather than card proliferation.
...
- [ ] density appropriate
- [ ] panels contextual
- [ ] advanced settings disclosed
- [ ] alignment stable
- [ ] empty chrome minimized
...
- `../../../../handbook/patterns/editor.md`
- `../../../../handbook/patterns/settings.md`
