---
name: crimson-ui-design-system-token-architecture
description: Deep aspect subskill for token architecture within the Crimson UI Design MAX system.
---
...
Create layered raw, semantic, and component tokens without turning the system into hardcoded aliases.
...
Separate primitive/raw values from semantic roles and component-level decisions.
...
Name semantic tokens by purpose rather than current color/size appearance.
...
Keep a small stable spacing/type/radius/elevation foundation and allow documented exceptions.
...
Avoid one-off local tokens that merely hide arbitrary values.
...
Trace actual usage before deleting or renaming shared tokens.
