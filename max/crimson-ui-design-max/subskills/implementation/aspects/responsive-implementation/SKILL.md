---
name: crimson-ui-implementation-responsive-implementation
description: Deep aspect subskill for responsive implementation within the Crimson UI Design MAX system.
---
...
Encode adaptive behavior with content-driven rules instead of breakpoint patch stacks.
...
Use layout primitives that naturally reflow before adding breakpoints.
...
Choose breakpoints where composition fails, not from device brand lists.
...
Prefer container queries when component context matters more than viewport width and stack support permits.
...
Avoid duplicate desktop/mobile markup unless behavior truly diverges.
...
Test zoom, long localization strings, and dynamic content.
...
- [ ] duplicate markup minimized
- [ ] container behavior tested
- [ ] zoom/localization checked
- [ ] dynamic content robust
