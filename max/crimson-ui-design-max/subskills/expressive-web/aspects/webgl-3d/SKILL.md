---
name: crimson-ui-expressive-web-webgl-3d
description: Deep aspect subskill for webgl / 3d within the Crimson UI Design MAX system.
---
...
Use 3D only when it materially strengthens product identity, explanation, or interaction.
...
Define why 3D is better than 2D/media for the specific subject.
...
Provide loading, fallback, lower-power, and reduced-motion behavior.
...
Do not let canvas capture input that breaks expected scrolling/navigation unless intentional and recoverable.
...
Budget texture/model/shader cost and preserve legibility around the scene.
...
Keep primary actions available even if the 3D layer fails.
...
- [ ] 3D justification
- [ ] fallback exists
- [ ] input ownership safe
- [ ] performance budget set
- [ ] primary actions independent
