---
name: crimson-ui-review-before-after-verification
description: Deep aspect subskill for before / after verification within the Crimson UI Design MAX system.
---
...
Verify that the redesign actually improved the same product state rather than only producing a prettier screenshot.
...
Compare equivalent viewport, content, theme, data, and interaction state whenever possible.
...
Check both visual improvement and preserved functionality.
...
Verify responsive and interaction states affected by the change.
...
Record BLOCKED conditions instead of silently skipping them.
...
Stop when acceptance is met and further change would mainly create churn.
...
- `../../../../handbook/qa/interaction-audit.md`
