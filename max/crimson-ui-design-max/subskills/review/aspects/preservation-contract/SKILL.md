---
name: crimson-ui-review-preservation-contract
description: Deep aspect subskill for preservation contract within the Crimson UI Design MAX system.
---
...
Define what must survive a redesign so visual improvement does not break product behavior.
...
List workflows, routes, state, shortcuts, integrations, permissions, accessibility behavior, and platform conventions that must remain intact.
...
Distinguish visual freedom from behavioral freedom; a full visual rewrite does not imply a business-logic rewrite.
...
Identify user-owned data and irreversible actions before touching interaction structure.
...
Preserve useful domain identity even when replacing a weak visual system.
...
Make explicit what may be removed, renamed, moved, or consolidated.
...
- [ ] must-preserve list exists
- [ ] allowed-to-change list exists
- [ ] data-loss risks identified
- [ ] feature removals explicit
- [ ] behavioral regression plan exists
...
- `../../../../handbook/core/workflow-and-evidence.md`
- `../../../../handbook/core/errors-recovery.md`
