...
Use Environment, Dynamic Type, semantic colors, NavigationStack/SplitView, safe areas, focus, accessibility modifiers, state ownership, and platform-specific presentation. Avoid fixed frames that break text scaling.
