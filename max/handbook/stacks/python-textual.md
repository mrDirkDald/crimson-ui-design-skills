...
Design for keyboard navigation, terminal resize, focus, command palette, dense information, color capability, and textual state. Icons should not depend on emoji width; use safe glyphs only when terminal rendering is controlled.
