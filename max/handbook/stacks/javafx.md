...
Use CSS stylesheets, scene graph layout panes, observable state/bindings, pseudo-classes, accessible roles, and scalable fonts. Avoid absolute coordinates unless the content itself is spatial.
