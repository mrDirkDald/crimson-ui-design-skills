...
Treat UI as web UI: semantic HTML/CSS, component states, navigation, focus, loading, forms. Preserve server/WebAssembly latency differences and reconnect states.
