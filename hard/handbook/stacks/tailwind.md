...
Use semantic wrappers/tokens rather than accumulating arbitrary values. Avoid giant unreadable class strings through component extraction where useful. Do not force named Tailwind palette colors when a coherent custom palette is better.
