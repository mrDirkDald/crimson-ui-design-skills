...
Use themes/styles/resources, pseudo-classes, templates, responsive layout primitives, and platform-aware window behavior. Verify Linux/Windows/macOS font and window differences when relevant.
