# UIKit / AppKit / Objective-C

## Implementation lens

Use native controls and Auto Layout/constrains, trait environments, Dynamic Type, accessibility APIs, navigation/window conventions, and appearance adaptation. Customize only where product value exceeds lost native behavior.
