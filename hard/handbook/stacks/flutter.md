...
Define ThemeData/ColorScheme/text themes or a coherent custom token layer. Use constraints rather than fixed pixel layouts, adaptive widgets where appropriate, MediaQuery/safe areas, semantics, focus traversal, and responsive composition.
