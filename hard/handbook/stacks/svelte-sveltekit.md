...
Keep state and transitions scoped, preserve progressive enhancement, use semantic HTML and CSS variables, avoid animation overload, and test SSR/hydration states.
