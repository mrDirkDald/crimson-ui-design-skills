...
Treat renderer UI separately from native privilege/security. Preserve command/IPC contracts. Keep file/process/updater permissions narrow. Apply web design to renderer and desktop/window conventions to shell.
