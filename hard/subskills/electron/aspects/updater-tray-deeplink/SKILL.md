---
name: crimson-ui-electron-updater-tray-deeplink
description: Deep aspect subskill for updater, tray, and deep links within the Crimson UI Design MAX system.
---

# Updater, Tray, and Deep Links

## Purpose

Design lifecycle surfaces that often sit outside the main window.
...
Make update states explicit: checking, available, downloading, ready, failed, deferred.
...
Do not force disruptive restarts without product reason.
...
Keep tray behavior predictable and consistent with whether the app is still running.
...
Validate and route deep links safely and surface failures clearly.
...
Ensure background behavior is understandable when the main window closes.
...
- [ ] update states complete
- [ ] restart policy clear
- [ ] tray lifecycle clear
- [ ] deep links validated
- [ ] background state understandable
