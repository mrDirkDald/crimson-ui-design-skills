---
name: crimson-ui-color-color-accessibility
description: Deep aspect subskill for color accessibility within the Crimson UI Design MAX system.
---
...
Ensure color remains readable and non-exclusive as a carrier of meaning.
...
Treat contrast and harmony as independent gates; both must pass.
...
Do not rely solely on red/green, blue/purple, or hue-only distinctions for critical state.
...
Add labels, icons, shapes, patterns, position, or line styles when color vision differences could collapse meaning.
...
Check real foreground/background pairs, not palette values in isolation.
...
Verify focus and selection states under both themes and high-contrast constraints where relevant.
...
- [ ] critical states distinguishable
- [ ] focus visible
- [ ] theme variants checked
...
- `../../../../handbook/core/accessibility.md`
