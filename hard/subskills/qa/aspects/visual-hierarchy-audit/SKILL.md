---
name: crimson-ui-qa-visual-hierarchy-audit
description: Deep aspect subskill for visual hierarchy audit within the Crimson UI Design MAX system.
---
...
Audit anchors, action priority, composition, typography, density, surfaces, and product specificity.
...
Judge whole-surface hierarchy before inspecting local polish.
...
Check whether visual mass matches task importance.
...
Look for duplicate CTAs, support-surface competition, tiny metadata fog, and card proliferation.
...
Test product specificity without relying on logo/hero art.
...
Record evidence at exact state/viewport rather than generic impressions.
...
- [ ] support subordinate
- [ ] type hierarchy coherent
- [ ] product specificity adequate
