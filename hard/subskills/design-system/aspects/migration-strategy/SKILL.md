---
name: crimson-ui-design-system-migration-strategy
description: Deep aspect subskill for design system migration within the Crimson UI Design MAX system.
---
...
Move from legacy styling/components to a new system without requiring a risky all-at-once rewrite.
...
Define compatibility boundaries and migration order by impact and reuse.
...
Introduce adapters/wrappers when they reduce churn safely.
...
Do not maintain two full competing systems indefinitely; set an exit strategy.
...
Verify migrated components in real product contexts, not only story/demo isolation.
...
Track behavior, accessibility, and visual parity separately during migration.
...
- [ ] exit criteria set
- [ ] real surfaces verified
- [ ] behavior/a11y parity checked
