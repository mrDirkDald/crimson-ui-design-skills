---
name: crimson-ui-visual-motion-language
description: Deep aspect subskill for motion language within the Crimson UI Design MAX system.
---
...
Define motion as state, continuity, hierarchy, and brand expression rather than decoration.

This is a **deep aspect subskill**. Use it after loading the parent `visual` skill when this aspect materially affects the result.
...
Assign every animation a job: feedback, state transition, spatial continuity, hierarchy, or narrative expression.
...
Keep repeated operational interactions faster and quieter than campaign/hero moments.
...
Avoid transition-all and avoid stacking parallax, cursor effects, wipes, pinned scroll, and text reveals without one experience thesis.
...
Respect reduced-motion preferences and lower-capability environments.
...
Verify interruption, rapid repeated input, resize, and route changes do not leave stale animation state.
...
- [ ] motion purpose stated
- [ ] durations proportional
- [ ] reduced motion supported
- [ ] interruptibility tested
- [ ] no effect soup
...
- `../../../../handbook/core/motion-deep.md`
- `../../../../handbook/core/motion-interaction.md`
