---
name: crimson-ui-tauri-updater-tray-deeplink
...
Handle lifecycle integrations in a way that matches desktop expectations.
...
Represent update lifecycle explicitly and avoid surprise restart behavior.
...
Keep tray presence and window-close behavior understandable.
...
Validate deep-link payloads before privileged action.
...
Surface failures in-context rather than silently dropping external intents.
...
Ensure startup/background behavior is compatible with platform conventions.
...
- `../../../../references/tauri-native-security.md`
