---
name: crimson-ui-web-responsive-layout
description: Deep aspect subskill for responsive layout within the Crimson UI Design MAX system.
---
...
Recompose web interfaces across widths rather than shrinking or vertically stacking desktop blindly.
...
Preserve task priority and reading order as layout changes.
...
Transform navigation, sidebars, inspectors, dense tables, and multi-column actions deliberately.
...
Define container behavior, breakpoints from content pressure, and minimum viable control sizes.
...
Handle keyboard/touch differences, safe areas, zoom, large text, and orientation changes.
...
Verify real content extremes rather than only ideal mock content.
...
- `../../../../handbook/core/responsive-adaptive.md`
