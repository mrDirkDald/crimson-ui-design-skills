---
name: crimson-ui-web-web-state-feedback
description: Deep aspect subskill for web state and feedback within the Crimson UI Design MAX system.
---

# Web State and Feedback

## Purpose

Make async actions, optimistic updates, loading, retry, offline, and stale states understandable.

This is a **deep aspect subskill**. Use it after loading the parent `web` skill when this aspect materially affects the result.
...
Differentiate action-in-progress from page-loading and background refresh.
...
Use optimistic UI only when rollback/reconciliation is safe and understandable.
...
Avoid spinners that erase context; preserve stable structure where possible.
...
Provide retry/recovery paths for recoverable failures.
...
Represent stale/offline/permission-denied states explicitly when they alter trust or available actions.
...
- [ ] async ownership clear
- [ ] rollback path exists
- [ ] loading preserves context
- [ ] retry visible
- [ ] offline/stale distinguished
