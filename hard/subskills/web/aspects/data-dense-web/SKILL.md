---
name: crimson-ui-web-data-dense-web
description: Deep aspect subskill for data-dense web interfaces within the Crimson UI Design MAX system.
---

# Data-Dense Web Interfaces

## Purpose

Design tables, dashboards, filters, charts, and dense web workspaces without turning everything into cards.
...
Prioritize decision-support information above decorative summaries.
...
Use stable alignment and column behavior for scanability.
...
Keep filter/sort/search state visible and recoverable.
...
Handle empty, partial, loading, stale, and error data independently.
...
Use progressive disclosure for secondary detail instead of dumping metadata into every row/card.
...
- [ ] decision path obvious
- [ ] filters visible
- [ ] table density appropriate
- [ ] data states distinct
- [ ] metadata controlled
...
- `../../../../handbook/patterns/dashboard.md`
- `../../../../handbook/patterns/admin-data-table.md`
